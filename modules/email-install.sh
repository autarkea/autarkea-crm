...
echo -e "${YELLOW}   Reply-To будет идти на email менеджера (если указан в проекте и адрес валиден).${NC}"
echo -e "${YELLOW}   Скрытой копии (BCC) нет — с v4.64.4 письмо уходит только клиенту.${NC}"
echo ""
